# Instead of FasterRCNN, we use MobileNet-SSD or YOLOv5n/YOLOv8n — they’re way faster and designed for real-time detection.
...
# Now naturally we'd want a stronger model - as the base ~Feel of this one is that the neural net is not strong enough to capture and fulfill the task at our hands: Real-Time Resturant Safety detection.
# Let's continue exploring - and if hitting some hardware bottlenecks, we move onto PC & GPUs.
